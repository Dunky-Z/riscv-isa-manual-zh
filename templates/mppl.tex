...
% 主要中文字体
\newcommand*{\thecjkmainfont}{$if(CJKmainfont)$$CJKmainfont$$else$Noto Sans Mono CJK SC$endif$}

% 主要英文字体
\newcommand*{\themainfont}{$if(mainfont)$$mainfont$$else$Ubuntu$endif$}

% Mono字体，用于代码块
\newcommand*{\themonofont}{$if(monofont)$$monofont$$else$Ubuntu$endif$}
